...
public class ClusterQualitySummarizer extends AbstractJob {
	...
	public int run(String[] args) throws IOException {
		...
		try {
			...
			System.out.printf("[Cost] First: %f", ClusteringUtils.totalClusterCost(datapoints, centroids));
			if (compareSummaries != null) {
				System.out.printf(" Second: %f\n", ClusteringUtils.totalClusterCost(datapoints, centroidsCompare));
			} else {
				System.out.printf("\n");
			}
/*			Matrix cMatrix = ClusteringUtils.getConfusionMatrix(centroids, centroidsCompare, datapoints, distanceMeasure);
			System.out.printf("[Confusion Matrix] First: %f", cMatrix);
			System.out.printf("[Adjusted Rand Index] First: %f", ClusteringUtils.getAdjustedRandIndex(cMatrix));
			if (compareSummaries != null) {
				System.out.printf(" Second: %f\n", ClusteringUtils.getAdjustedRandIndex(cMatrix));
			} else {
				System.out.printf("\n");
			}*/
