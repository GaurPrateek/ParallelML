...
public class EnsembleReducer extends Reducer<IntWritable, VectorSingleLabeledWritable, Text, VectorWritable> {
	...
	public void reduce(IntWritable key, Iterable<VectorSingleLabeledWritable> values, Context context) throws IOException, InterruptedException {
		...
		newkeys.append("#"+String.valueOf(key.get()));

		context.write(new Text(newkeys.toString()), new VectorWritable(w1));
	}
