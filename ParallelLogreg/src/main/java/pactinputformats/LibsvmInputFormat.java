 ...
 * 
 */
public class LibsvmInputFormat extends DelimitedInputFormat<Record> {
	...
	private final IntValue label = new IntValue();

	private final PactVector features = new PactVector();

	// -------------------------------------- Internal --------------------------------------------

	private IntValue index = new IntValue();

	private DoubleValue weight = new DoubleValue();
